...
export function Hero_V2() {
    return (
        ...
        >
            ...
            <div
                className="pointer-events-none absolute inset-x-0 top-0 z-0 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent"
                aria-hidden="true"
            />

            <div className="relative z-10 mx-auto w-full max-w-7xl px-4 pb-10 sm:px-6 sm:pb-14 lg:px-8 lg:pb-20 lg:pt-24">
                {/* Rotating headline */}
                <motion.div
                ...
                {/* Portfolio + search - one unified card */}
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
