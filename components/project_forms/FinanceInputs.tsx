...
export function CurrencyInput({
    ...
    const isOverMax =
        ...
        Math.abs(rawNum) > FINANCE_MAX;

    const displayValue = focused ? draftValue : formatCurrencyForDisplay(value);
    ...
    return (
        <div>
            ...
            >
                <span
                    className={`inline-flex items-center justify-center w-9 border-r text-sm font-semibold shrink-0 transition-colors ${
                        isOverMax
            ...
            {isOverMax ? (
                ...
                <p className="mt-0.5 text-[10px] text-slate-400">
                    e.g. 1,500,000.00 · max $999,999,999,999
                </p>
            )}
        </div>
    );
    ...
    return (
        <div>
            ...
            >
                ...
                <span
                    className={`inline-flex items-center px-3 border-l text-sm font-medium shrink-0 min-w-[72px] justify-center transition-colors tabular-nums ${
                        pct !== null && isValid
...
export function IntegerInput({
    ...
    const isInvalid =
        value !== '' &&
        (!Number.isFinite(n) || n < 0 || String(n) !== value.trim());
