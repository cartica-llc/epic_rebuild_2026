        ...
        <div className="overflow-x-auto">
            <table className="w-full text-left text-sm">
                ...
                <tr className="border-b border-slate-200">
                    ...
                    {!hideStatus && <th className="px-3 py-3 text-xs font-semibold text-slate-500">Status</th>}
                    <th className="px-3 py-3 text-xs font-semibold text-slate-500">Last Modified</th>
        ...
        <div className="rounded-2xl bg-white shadow-sm ring-1 ring-slate-200/70">
            ...
            <div className="p-2">
                {activeTab === 'active' ? (
                    ...
                    <>
                        <div className="flex items-center gap-2 rounded-lg bg-amber-50 border border-amber-200 px-4 py-2.5 mx-2 mt-2 text-xs text-amber-800">
